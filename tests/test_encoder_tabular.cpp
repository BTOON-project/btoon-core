...
TEST(EncoderTest, EncodeTabular) {
    ...
    // Debug: Check what type "a" actually is
    auto& val_a = (*row1)["a"];
    ...
    // Debug: Check what type "b" actually is
    auto& val_b = (*row1)["b"];
    ...
    // Debug: Check what type "a" actually is in row 2
    auto& val2_a = (*row2)["a"];
    ...
    // Debug: Check what type "b" actually is in row 2
    auto& val2_b = (*row2)["b"];
